...
.. |img_travis| image:: https://travis-ci.com/saltstack-formulas/rng-tools-formula.svg?branch=master
   :alt: Travis CI Build Status
   :scale: 100%
   :target: https://travis-ci.com/saltstack-formulas/rng-tools-formula
